...
- **[BACK-END SERVICES INSTALLATION INSTRUCTIONS](#back-end-services-installation-instructions)**: Instructions to get the back-end up and running.
- **[FRONT-END INSTALLATION INSTRUCTIONS](#front-end-installation-instructions)**: Instructions to get the front-end up and running.
